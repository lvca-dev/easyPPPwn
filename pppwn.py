...
class Exploit():
    ...
    def run(self):
        ...
        if not corrupted:
            print('[-] Failed to exploit, simply press up and enter to try again!')
            exit(1)
...
def main():
    ...
    print('[+] EasyPPPwn by lvca, Originally made by Andy Nguyen, TheFl0w')
